...
if ($Logging -eq $true) {
    ...
    $Results | Select Date,CustomerName,FirstName,LastName,Username,Role,LastLogin,Enabled | Sort Role,LastLogin,FirstName | Export-CSV -Path $LogFile -NoTypeInformation 
