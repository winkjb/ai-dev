<#
.SYNOPSIS
    Unattended entry point for Asphalt Enterprises's SharePoint disable audit - runs the collector then the
    analyst and emails the findings. Meant to be called from a scheduled task; logs to
    output/run-logs-{yyyy-MM}.log (shared with Asphalt Enterprises's other audits, one file per month) since
