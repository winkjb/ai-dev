...
.EXAMPLE
    .\Invoke-PolicyAudit-Locations-Default.ps1
#>
...
$AuditCsv = Join-Path $PSScriptRoot "..\02-analyst\output\$($CustomerDir)\Locations-Audit.csv"
...
try {
    ...
    & (Join-Path $PSScriptRoot "..\01-collector\Collect-EntraLocations.ps1") -Directory $CustomerDir -SettingsPath $SettingsPath
    Write-ToLog -LogFile $OutputFile -Message "Collected Entra named locations"

    & (Join-Path $PSScriptRoot "..\02-analyst\Compare-EntraLocations.ps1") -Directory $CustomerDir
