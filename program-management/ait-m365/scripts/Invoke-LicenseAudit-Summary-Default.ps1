...
.EXAMPLE
    .\Invoke-LicenseAudit-Summary-Default.ps1
#>
...
$AuditCsv = Join-Path $PSScriptRoot "..\02-analyst\output\$($CustomerDir)\LicenseAudit-Summary.csv"
...
try {
    ...
    & (Join-Path $PSScriptRoot "..\02-analyst\Compare-LicenseSummary.ps1") -Directory $CustomerDir
