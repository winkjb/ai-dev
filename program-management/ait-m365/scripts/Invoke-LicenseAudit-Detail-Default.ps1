...
.EXAMPLE
    .\Invoke-LicenseAudit-Detail-Default.ps1
#>
...
$AuditCsv = Join-Path $PSScriptRoot "..\02-analyst\output\$($CustomerDir)\LicenseAudit-Detail.csv"
...
try {
    ...
    & (Join-Path $PSScriptRoot "..\02-analyst\Compare-LicenseDetail.ps1") -Directory $CustomerDir
