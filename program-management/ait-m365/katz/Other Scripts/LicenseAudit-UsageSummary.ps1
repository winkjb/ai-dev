...
$ExcludedLicenses = @("WINDOWS_STORE") # Multiple groups allowed but MUST be independent strings separated by comma
...
$ScriptPath = "C:\PS\Scripts\Ad-Azure\LicenseAudit-UsageSummary-Default.ps1"
