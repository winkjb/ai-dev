...
.SYNOPSIS
    ...
    ../katz/Invoke-LicenseAuditSummary.ps1).
...
.EXAMPLE
    .\Compare-LicenseSummaryAudit.ps1 -Directory katz
#>
...
if (-not $OutputPath)     { $OutputPath     = Join-Path $PSScriptRoot "output\$Directory\license-summary-audit.csv" }
