...
.SYNOPSIS
    ...
    scripts (../02-analyst/Compare-EntraLocations.ps1) read this file rather than calling
    Graph directly.
...
.DESCRIPTION
    ...
    original katz/Invoke-PolicyAudit-Locations-Default.ps1 script did - an IP-based location
...
.EXAMPLE
    .\Collect-EntraLocations.ps1 -Directory katz
#>
