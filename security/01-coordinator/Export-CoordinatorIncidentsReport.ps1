...
.EXAMPLE
    .\Export-CoordinatorIncidentsReport.ps1
#>
...
$OutputDetail = Join-Path $OutputDir "coordinator-incidents-detail.csv"
$OutputSummary = Join-Path $OutputDir "coordinator-incidents-summary.md"
$OutputSummaryCsv = Join-Path $OutputDir "coordinator-incidents-summary.csv"
